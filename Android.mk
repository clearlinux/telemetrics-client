...
DATA_DIR := ""
BACK_END_ADDR := ""
LSTATE_DIR := "/data/vendor/telemetrics"
...
$(GEN): GEN_TOOL := $(shell $(TELEM_PATH)/android_config_gen.sh $(IN_PATH))
$(GEN): $(GEN_TOOL)
...
LOCAL_CFLAGS += -DDATADIR='$(DATA_DIR)' \
    -DBACKEND_ADDR='$(BACK_END_ADDR)' \
    -DLOCALSTATEDIR='$(LSTATE_DIR)'
...
LOCAL_LDLIBS := -llog
LOCAL_CFLAGS += -Wno-unused-parameter
LOCAL_CFLAGS += -DLOCALSTATEDIR='$(LSTATE_DIR)'
$(LOCAL_MODULE): $(LOCAL_DEPENDENCY_HEAD)
